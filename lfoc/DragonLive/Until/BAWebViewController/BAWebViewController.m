...
//    [self.view endEditing:YES];
    ...
    [self performSelector:@selector(aaa) afterDelay:0.1];
...
-(void)aaa{
    CGPoint bottomOffset = CGPointMake(0, _webView.scrollView.contentSize.height-_webView.scrollView.bounds.size.height);
        ...
        if ([self.urlString isEqualToString:@"https://www.chuanyinke.com/kefu/6001227a81cc7"]) {
...
//        BAKit_StrongSelf
    ...
    self.webView.ba_web_didFinishBlock = ^(WKWebView *webView, WKNavigation *navigation) {
        ...
        if ([weakself.urlString isEqualToString:@"https://www.chuanyinke.com/kefu/6001227a81cc7"]) {
            if ([webView subviews]){
...
- (void)configBackItem
{
    ...
    [backBtn setTintColor:[UIColor colorFromHexString:@"222222"]];
...
- (void)viewDidLayoutSubviews {
    ...
    self.webView.frame = CGRectMake(0, 0, BAKit_SCREEN_WIDTH, BAKit_SCREEN_HEIGHT-kTopHeight-kBottomSafeHeight);
