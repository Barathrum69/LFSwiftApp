...
-(void)setView{
    ...
    if (!self.wordNumLabel) {
        ...
        self.wordNumLabel.backgroundColor = [UIColor whiteColor];
...
- (void)refreshFram{
    ...
    if (self.contentSize.height>self.frame.size.height-self.wordNumLabel.frame.size.height-5) {
        self.wordNumLabel.frame = CGRectMake(self.frame.size.width - self.wordNumLabel.frame.size.width-5, self.contentSize.height-self.wordNumLabel.height/2, self.wordNumLabel.frame.size.width, self.wordNumLabel.frame.size.height);
        self.contentInset = UIEdgeInsetsMake(0, 0, self.wordNumLabel.frame.size.height, 0);
        
    }else{
        self.wordNumLabel.frame = CGRectMake(self.frame.size.width - self.wordNumLabel.frame.size.width-5, self.frame.size.height-self.wordNumLabel.frame.size.height, self.wordNumLabel.frame.size.width, self.wordNumLabel.frame.size.height );
