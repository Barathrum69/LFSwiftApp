...
- (instancetype)init{
    if (self = [super init]) {
        ...
        self.backgroundColor = [[UIColor colorFromHexString:@"000000"] colorWithAlphaComponent:0.5];
...
- (void)showText:(NSString *)text withSecond:(NSInteger)delay view:(UIView *)view
{
    {
        _coverView = [UIView new];
        UIWindow * current_window = nil;
