...
//        [lbl setTranslatesAutoresizingMaskIntoConstraints:YES];
        lbl;
    });
...
- (UIView *)createGridLine{
    UIView *v = [UIView new];
    v.hidden = YES;
    v.backgroundColor = [UIColor colorWithRed:188/255.0f green:188/255.0f blue:188/255.0f alpha:1];
...
- (void)setupLayout{
    NSDictionary *dictMetrics = @{@"hPaddingValue":@5,@"lineSize":@1.0f};
