...
- (void)setFields:(NSArray *)fields andWidths:(NSArray *)widths{
    ...
    contentView.backgroundColor = [UIColor colorWithRed:188/255.0 green:188/255.0 blue:188/255.0 alpha:1.0];
    ...
    [_fields enumerateObjectsUsingBlock:^(NSString*  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        btn.tag = idx;
        btn.backgroundColor = [UIColor colorWithRed:231/255.0 green:231/255.0 blue:231/255.0 alpha:1.0];
        [btn setTitle:obj forState:UIControlStateNormal];
        btn.titleLabel.font =[UIFont boldSystemFontOfSize:kWidth(13)];
