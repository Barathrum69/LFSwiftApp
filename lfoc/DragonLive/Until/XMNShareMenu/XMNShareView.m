...
- (void)_updateshareContentViewFrame:(BOOL)hidden {
    ...
    self.shareContentView.frame = CGRectMake(0, hidden ? self.frame.size.height : self.frame.size.height - height-kBottomSafeHeight, CGRectGetWidth(self.bounds), height+kBottomSafeHeight);
}
